<div class="doctypes index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('doctype_name'); ?></th>
			<th><?php echo $this->Paginator->sort('doctype_desc'); ?></th>
			<th><?php echo $this->Paginator->sort('doctype_status'); ?></th>
			<th><?php echo $this->Paginator->sort('doctype_order'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($doctype['Doctype']['doctype_desc']); ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $doctype['Doctype']['doctype_id']), null, __('Are you sure you want to delete # %s?', $doctype['Doctype']['doctype_id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
