<div class="col-md-12">
    <div class="block-flat">
        <div class="header">
            <?php if(isset($_keySearch)):?>
            <h3 class="new-document"><?php echo __("Tìm kết quả cho: %s", $_keySearch) ?></h3>
            <?php endif; ?>
        </div>
        <div class="content">
            <div class="table-responsive">
                <?php if(isset($_documents) && count($_documents)): ?>
                    <div id="datatable_wrapper" class="dataTables_wrapper form-inline" role="grid">
                        <table class="table table-bordered dataTable" id="datatable" aria-describedby="datatable_info">
                            ...
                            <?php $i = 0;
                            foreach ($_documents as $_document): $i++ ?>
